...
const drills: PrivateDrill[] = [
  ...
  },
  {
    ...
    summary: "Review an AI-proposed student advising assistant architecture and turn its confident gaps into explicit engineering decisions.",
    prompt: "The attached proposal was generated by an AI for a university career advising assistant. Write a design review that identifies the most important risks, proposes a safer architecture, and explains how you would roll it out. Separate facts, assumptions, and decisions.",
